...
class SVec3Test {
    ...
    fun `init correct min`() {
        val position = SVec3(-511, -511, -511)
    }
    ...
    fun `init badly`() {
        ...
        assertThrows<AssertionError> { SVec3(-40_000_000, -5000, -40_000_000) }
    }

    @Test
    fun `correct positive x`() {
        val position = SVec3(2, 0xF, 0xF)
        assertEquals(position.x, 2)
    }

    @Test
    fun `correct positive x large`() {
        val position = SVec3(511, 0xF, 0xF)
    ...
    fun `correct negative y`() {
        val position = SVec3(0xF, -29, 0xF)
        assertEquals(position.y, -29)
    }

    @Test
    fun `correct negative y large`() {
        val position = SVec3(42, -511, 0xF)
    ...
    fun `correct positive y large`() {
        val position = SVec3(0xF, 511, 0xF)
        assertEquals(position.y, 511)
    }

    @Test
    fun `correct plus y`() {
        val position = SVec3(0xF, 2, 0xF)
    ...
    fun `correct positive z`() {
        val position = SVec3(0xF, 0xF, 4)
        assertEquals(position.z, 4)
    }

    @Test
    fun `correct positive z large`() {
        val position = SVec3(0, 0, 500)
