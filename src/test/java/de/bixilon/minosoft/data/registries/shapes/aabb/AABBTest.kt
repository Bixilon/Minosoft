...
internal class AABBTest {
    ...
    fun testMaxDistance1() {
        ...
        assertEquals(1239312.0, a.calculateMaxDistance(b, Vec3d(), 1239312.0, Axes.Z))
    }
    ...
    fun testMaxDistance2() {
        ...
        assertNotEquals(0.1, a.calculateMaxDistance(b, Vec3d(), 0.1, Axes.Z))
    }
    ...
    fun testMaxDistance3() {
        ...
        assertEquals(0.0, a.calculateMaxDistance(b, Vec3d(), -0.0784000015258789, Axes.Y))
    }
