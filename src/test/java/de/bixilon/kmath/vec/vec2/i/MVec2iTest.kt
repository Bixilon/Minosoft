...
class MMVec2iTest {
    ...
    @Test
    fun `unary plus`() {
        val vec = MVec2i(10, 20)
        val expected = MVec2i(10, 20)
    ...
    @Test
    fun `increment once`() {
        var vec = MVec2i(10, 20)
        vec++
        val expected = MVec2i(11, 21)
