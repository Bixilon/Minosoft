...
class MVec2fTest {
    ...
    fun `plus same type`() {
        ...
        val b = Vec2f(10.0f, 20.0f)
        val expected = Vec2f(11.0f, 22.0f)
    ...
    fun `plus number`() {
        val a = Vec2f(1.0f, 2.0f)
        val expected = Vec2f(11.0f, 12.0f)
    ...
    fun `times number`() {
        val a = Vec2f(1.0f, 2.0f)
        val expected = Vec2f(2.0f, 4.0f)
        assertEquals(a * 2.0f, expected)
    }

    @Test
    fun `div same type`() {
        val a = Vec2f(10.0f, 20.0f)
        val b = Vec2f(2.0f, 2.0f)
        val expected = Vec2f(5.0f, 10.0f)
        assertEquals(a / b, expected)
    }
    ...
    @Test
    fun `unary plus`() {
        val vec = Vec2f(10.0f, 20.0f)
        val expected = Vec2f(10.0f, 20.0f)
    ...
    @Test
    fun `increment once`() {
        var vec = Vec2f(10.0f, 20.0f)
        vec++
        val expected = Vec2f(11.0f, 21.0f)
