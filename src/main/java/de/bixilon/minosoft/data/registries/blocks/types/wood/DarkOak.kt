...
interface DarkOak {
    ...
    class Stairs(identifier: ResourceLocation = this.identifier, settings: BlockSettings) : StairsBlock.Wooden(identifier, settings), DarkOak {

        companion object : BlockFactory<Stairs> {
            override val identifier = minecraft("dark_oak_stairs")
