...
open class SkullBlock(resourceLocation: ResourceLocation, registries: Registries, data: Map<String, Any>) : PixLyzerBlockWithEntity<BlockEntity>(resourceLocation, registries, data) {
    ...
    companion object : PixLyzerBlockFactory<SkullBlock> {
        override fun build(resourceLocation: ResourceLocation, registries: Registries, data: Map<String, Any>): SkullBlock {
            return SkullBlock(resourceLocation, registries, data)
        }
    }
}
