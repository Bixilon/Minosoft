...
interface CobbledDeepslate : Stone {
    override val hardness get() = 3.5f

    open class Block(identifier: ResourceLocation = Companion.identifier, settings: BlockSettings) : RockBlock(identifier, settings), CobbledDeepslate {
    ...
    class Slab(identifier: ResourceLocation = this.identifier, settings: BlockSettings) : SlabBlock.Stone(identifier, settings), CobbledDeepslate {
    ...
    class Stairs(identifier: ResourceLocation = this.identifier, settings: BlockSettings) : StairsBlock.Stone(identifier, settings), CobbledDeepslate {
        override val hardness get() = super<CobbledDeepslate>.hardness

        companion object : BlockFactory<Stairs> {
            override val identifier = minecraft("cobbled_deepslate_stairs")
