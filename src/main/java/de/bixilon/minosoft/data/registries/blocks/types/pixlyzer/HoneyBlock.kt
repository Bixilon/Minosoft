...
open class HoneyBlock(resourceLocation: ResourceLocation, registries: Registries, data: Map<String, Any>) : PixLyzerBlock(resourceLocation, registries, data) {
    ...
    companion object : PixLyzerBlockFactory<HoneyBlock> {
