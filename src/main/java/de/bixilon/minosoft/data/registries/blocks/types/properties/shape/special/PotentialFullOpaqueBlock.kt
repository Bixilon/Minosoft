...
/**
 * A block that might be fully opaque block, depending on block properties
 */
interface PotentialFullOpaqueBlock : OpaqueBlock, LightedBlock {

    fun isFullOpaque(state: BlockState): Boolean
}
