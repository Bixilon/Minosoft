...
interface MudBrick : HardnessBlock {
    override val hardness get() = 1.5f

    open class Block(identifier: ResourceLocation = Companion.identifier, settings: BlockSettings) : RockBlock(identifier, settings), MudBrick {

        companion object : BlockFactory<Block> {
            override val identifier = minecraft("mud_bricks")
