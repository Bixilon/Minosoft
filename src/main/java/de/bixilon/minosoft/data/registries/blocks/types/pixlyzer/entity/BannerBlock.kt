...
open class BannerBlock(resourceLocation: ResourceLocation, registries: Registries, data: Map<String, Any>) : PixLyzerBlockWithEntity<BlockEntity>(resourceLocation, registries, data) {
    ...
    companion object : PixLyzerBlockFactory<BannerBlock> {
        override fun build(resourceLocation: ResourceLocation, registries: Registries, data: Map<String, Any>): BannerBlock {
            return BannerBlock(resourceLocation, registries, data)
        }
    }
}
