...
interface FloweringAzalea {
    ...
    class Stairs(identifier: ResourceLocation = this.identifier, settings: BlockSettings) : StairsBlock.Wooden(identifier, settings), FloweringAzalea {

        companion object : BlockFactory<Stairs> {
            override val identifier = minecraft("flowering_azalea_stairs")
