...
open class ConduitBlock(resourceLocation: ResourceLocation, registries: Registries, data: Map<String, Any>) : PixLyzerBlockWithEntity<BlockEntity>(resourceLocation, registries, data) {
    ...
    companion object : PixLyzerBlockFactory<ConduitBlock> {
        override fun build(resourceLocation: ResourceLocation, registries: Registries, data: Map<String, Any>): ConduitBlock {
            return ConduitBlock(resourceLocation, registries, data)
        }
    }
}
