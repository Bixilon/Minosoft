...
open class CommandBlock(resourceLocation: ResourceLocation, registries: Registries, data: Map<String, Any>) : PixLyzerBlockWithEntity<BlockEntity>(resourceLocation, registries, data) {
    ...
    companion object : PixLyzerBlockFactory<CommandBlock> {
        override fun build(resourceLocation: ResourceLocation, registries: Registries, data: Map<String, Any>): CommandBlock {
            return CommandBlock(resourceLocation, registries, data)
        }
    }
}
