...
interface RedNetherBrick : HardnessBlock {
    ...
    class Slab(identifier: ResourceLocation = this.identifier, settings: BlockSettings) : SlabBlock.Stone(identifier, settings), RedNetherBrick {
    ...
    class Stairs(identifier: ResourceLocation = this.identifier, settings: BlockSettings) : StairsBlock.Stone(identifier, settings), RedNetherBrick {
        override val hardness get() = super<RedNetherBrick>.hardness

        companion object : BlockFactory<Stairs> {
            override val identifier = minecraft("red_nether_brick_stairs")
