...
interface MossyStoneBrick : HardnessBlock {
    override val hardness get() = 1.5f

    open class Block(identifier: ResourceLocation = Companion.identifier, settings: BlockSettings) : RockBlock(identifier, settings), MossyStoneBrick {

        companion object : BlockFactory<Block> {
            override val identifier = minecraft("mossy_stone_bricks")
