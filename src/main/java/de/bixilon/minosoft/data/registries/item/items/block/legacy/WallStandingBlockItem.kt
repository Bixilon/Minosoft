...
open class WallStandingBlockItem(
    ...
    companion object : PixLyzerItemFactory<WallStandingBlockItem> {
        ...
        override fun build(identifier: ResourceLocation, registries: Registries, data: Map<String, Any>): WallStandingBlockItem {
            return WallStandingBlockItem(identifier, registries, data)
        }
    }
}
