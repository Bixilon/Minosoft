...
interface NetherBrick : HardnessBlock {
    override val hardness get() = 2.0f

    open class Block(identifier: ResourceLocation = Companion.identifier, settings: BlockSettings) : RockBlock(identifier, settings), NetherBrick {

        companion object : BlockFactory<Block> {
            override val identifier = minecraft("nether_bricks")
