...
interface Jungle {
    ...
    class Stairs(identifier: ResourceLocation = this.identifier, settings: BlockSettings) : StairsBlock.Wooden(identifier, settings), Jungle {

        companion object : BlockFactory<Stairs> {
            override val identifier = minecraft("jungle_stairs")
