...
class Generic9x2Container(connection: PlayConnection, type: ContainerType, title: ChatComponent?) : GenericContainer(2, connection, type, title) {

    companion object : ContainerFactory<Generic9x2Container> {
        override val RESOURCE_LOCATION: ResourceLocation = "minecraft:generic_9x2".toResourceLocation()
