...
class Generic9x4Container(connection: PlayConnection, type: ContainerType, title: ChatComponent?) : GenericContainer(4, connection, type, title) {

    companion object : ContainerFactory<Generic9x4Container> {
        override val RESOURCE_LOCATION: ResourceLocation = "minecraft:generic_9x4".toResourceLocation()
