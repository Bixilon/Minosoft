...
object ChestContainer : ContainerFactory<GenericContainer> {
    ...
    override fun build(session: PlaySession, type: ContainerType, title: ChatComponent?, slots: Int, id: Int): GenericContainer {
        ...
        return factory.build(session, type, title, slots, id)
    }
}
