...
interface HoverEvent : ChatEvent {
    ...
    fun onMouseEnter(guiRenderer: GUIRenderer, position: Vec2f, absolute: Vec2f) = false
    fun onMouseMove(guiRenderer: GUIRenderer, position: Vec2f, absolute: Vec2f) = false
