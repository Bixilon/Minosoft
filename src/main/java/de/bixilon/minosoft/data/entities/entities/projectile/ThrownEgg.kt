...
class ThrownEgg(session: PlaySession, entityType: EntityType, data: EntityData, position: Vec3d, rotation: EntityRotation) : ThrowableItemProjectile(session, entityType, data, position, rotation) {
