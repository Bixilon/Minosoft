...
class SnowGolem(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation) : AbstractGolem(connection, entityType, position, rotation) {
    ...
    companion object : EntityFactory<SnowGolem> {
        ...
        override fun build(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation): SnowGolem {
