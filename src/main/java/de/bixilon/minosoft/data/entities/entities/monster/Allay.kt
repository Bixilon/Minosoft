...
class Allay(connection: PlayConnection, entityType: EntityType, position: Vec3d, rotation: EntityRotation) : PathfinderMob(connection, entityType, position, rotation) {
    ...
    companion object : EntityFactory<Allay> {
        ...
        override fun build(connection: PlayConnection, entityType: EntityType, position: Vec3d, rotation: EntityRotation): Allay {
            return Allay(connection, entityType, position, rotation)
        }
    }
}
