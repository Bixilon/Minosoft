...
class Arrow(connection: PlayConnection, entityType: EntityType) : AbstractArrow(connection, entityType) {
    ...
    companion object : EntityFactory<Arrow> {
        ...
        override fun build(connection: PlayConnection, entityType: EntityType): Arrow {
            return Arrow(connection, entityType)
        }
    }
}
