...
class AreaEffectCloud(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation) : Entity(connection, entityType, position, rotation) {
    ...
    companion object : EntityFactory<AreaEffectCloud> {
        ...
        override fun build(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation): AreaEffectCloud {
