...
class Cat(connection: PlayConnection, entityType: EntityType) : TamableAnimal(connection, entityType) {
    ...
    companion object : EntityFactory<Cat> {
        ...
        override fun build(connection: PlayConnection, entityType: EntityType): Cat {
            return Cat(connection, entityType)
        }
    }
}
