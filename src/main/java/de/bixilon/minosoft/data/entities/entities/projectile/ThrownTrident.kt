...
class ThrownTrident(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation) : AbstractArrow(connection, entityType, position, rotation) {
    ...
    companion object : EntityFactory<ThrownTrident> {
        ...
        override fun build(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation): ThrownTrident {
