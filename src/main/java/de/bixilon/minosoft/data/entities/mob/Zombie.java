...
import de.bixilon.minosoft.data.entities.meta.ZombieMetaData;
...
public class Zombie extends Mob implements MobInterface {
    ...
    public Zombie(int entityId, UUID uuid, Location location, short yaw, short pitch, short headYaw, EntityMetaData.MetaDataHashMap sets, int protocolId) {
        super(entityId, uuid, location, yaw, pitch, headYaw);
        this.metaData = new ZombieMetaData(sets, protocolId);
    }
