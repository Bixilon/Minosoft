...
class Bee(connection: PlayConnection, entityType: EntityType) : Animal(connection, entityType) {
    ...
    companion object : EntityFactory<Bee> {
        ...
        override fun build(connection: PlayConnection, entityType: EntityType): Bee {
            return Bee(connection, entityType)
        }
    }
}
