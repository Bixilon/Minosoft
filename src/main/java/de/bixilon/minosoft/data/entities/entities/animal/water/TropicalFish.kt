...
class TropicalFish(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation) : AbstractSchoolingFish(connection, entityType, position, rotation) {
    ...
    companion object : EntityFactory<TropicalFish> {
        ...
        override fun build(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation): TropicalFish {
