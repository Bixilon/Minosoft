...
class CommandBlockMinecart(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation) : AbstractMinecart(connection, entityType, position, rotation) {
    ...
    companion object : EntityFactory<CommandBlockMinecart> {
        ...
        override fun build(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation): CommandBlockMinecart {
