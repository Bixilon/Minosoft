...
import de.bixilon.minosoft.data.entities.meta.StraySkeletonMetaData;
...
public class StraySkeleton extends Mob implements MobInterface {
    ...
    public StraySkeleton(int entityId, UUID uuid, Location location, short yaw, short pitch, short headYaw, EntityMetaData.MetaDataHashMap sets, int protocolId) {
        super(entityId, uuid, location, yaw, pitch, headYaw);
        this.metaData = new StraySkeletonMetaData(sets, protocolId);
    }
