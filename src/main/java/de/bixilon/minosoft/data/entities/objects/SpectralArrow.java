...
import de.bixilon.minosoft.data.entities.meta.SpectralArrowMetaData;
...
public class SpectralArrow extends EntityObject implements ObjectInterface {
    ...
    public SpectralArrow(int entityId, UUID uuid, Location location, short yaw, short pitch, short headYaw, EntityMetaData.MetaDataHashMap sets, int versionId) {
        super(entityId, uuid, location, yaw, pitch, headYaw);
        this.metaData = new SpectralArrowMetaData(sets, versionId);
        this.shooter = 0; // ToDo
    }
