...
abstract class AbstractFish(session: PlaySession, entityType: EntityType, data: EntityData, position: Vec3d, rotation: EntityRotation) : WaterAnimal(session, entityType, data, position, rotation) {
