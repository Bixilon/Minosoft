...
class Strider(session: PlaySession, entityType: EntityType, data: EntityData, position: Vec3d, rotation: EntityRotation) : Animal(session, entityType, data, position, rotation), ItemRideable, FluidWalker {
    ...
    companion object : EntityFactory<Strider> {
        ...
        override fun build(session: PlaySession, entityType: EntityType, data: EntityData, position: Vec3d, rotation: EntityRotation): Strider {
            return Strider(session, entityType, data, position, rotation)
        }
    }
}
