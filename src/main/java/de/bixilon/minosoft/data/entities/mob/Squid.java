...
import de.bixilon.minosoft.data.entities.meta.SquidMetaData;
...
public class Squid extends Mob implements MobInterface {
    ...
    public Squid(int entityId, UUID uuid, Location location, short yaw, short pitch, short headYaw, EntityMetaData.MetaDataHashMap sets, int versionId) {
        super(entityId, uuid, location, yaw, pitch, headYaw);
        this.metaData = new SquidMetaData(sets, versionId);
    }
