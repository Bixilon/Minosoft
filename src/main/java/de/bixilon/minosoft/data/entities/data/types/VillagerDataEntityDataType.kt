...
object VillagerDataEntityDataType : RegistryEntityDataType<VillagerData> {
    ...
    override fun read(buffer: PlayInByteBuffer): VillagerData? {
        val type = read(buffer, buffer.session.registries.villagerType) ?: return null
        val profession = read(buffer, buffer.session.registries.villagerProfession) ?: return null
