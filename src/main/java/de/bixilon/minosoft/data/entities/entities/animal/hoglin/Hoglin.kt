...
class Hoglin(connection: PlayConnection, entityType: EntityType) : Animal(connection, entityType) {
    ...
    companion object : EntityFactory<Hoglin> {
        ...
        override fun build(connection: PlayConnection, entityType: EntityType): Hoglin {
            return Hoglin(connection, entityType)
        }
    }
}
