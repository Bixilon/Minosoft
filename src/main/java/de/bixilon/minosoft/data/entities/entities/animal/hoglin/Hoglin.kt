...
class Hoglin(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation) : Animal(connection, entityType, position, rotation) {
    ...
    companion object : EntityFactory<Hoglin> {
        ...
        override fun build(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation): Hoglin {
