...
class GlowSquid(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation) : Squid(connection, entityType, position, rotation) {
    ...
    companion object : EntityFactory<GlowSquid> {
        ...
        override fun build(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation): GlowSquid {
