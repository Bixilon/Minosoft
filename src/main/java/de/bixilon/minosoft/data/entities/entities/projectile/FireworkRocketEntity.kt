...
class FireworkRocketEntity(connection: PlayConnection, entityType: EntityType, position: Vec3, rotation: EntityRotation) : Projectile(connection, entityType, position, rotation) {
    ...
    companion object : EntityFactory<FireworkRocketEntity> {
        ...
        override fun build(connection: PlayConnection, entityType: EntityType, position: Vec3, rotation: EntityRotation): FireworkRocketEntity {
