...
class FireworkRocketEntity(connection: PlayConnection, entityType: EntityType) : Projectile(connection, entityType) {
    ...
    companion object : EntityFactory<FireworkRocketEntity> {
        ...
        override fun build(connection: PlayConnection, entityType: EntityType): FireworkRocketEntity {
            return FireworkRocketEntity(connection, entityType)
        }
    }
}
