...
open class Slime(connection: PlayConnection, entityType: EntityType) : Mob(connection, entityType) {
    ...
    companion object : EntityFactory<Slime> {
        ...
        override fun build(connection: PlayConnection, entityType: EntityType): Slime {
            return Slime(connection, entityType)
        }
    }
}
