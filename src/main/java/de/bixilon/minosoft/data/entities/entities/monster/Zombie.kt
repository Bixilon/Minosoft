...
open class Zombie(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation) : Monster(connection, entityType, position, rotation) {
    ...
    companion object : EntityFactory<Zombie> {
        ...
        override fun build(connection: Connection, entityType: EntityType, position: Vec3, rotation: EntityRotation): Zombie {
