...
class SmallFireball(connection: PlayConnection, entityType: EntityType) : Fireball(connection, entityType) {
    ...
    companion object : EntityFactory<SmallFireball> {
        ...
        override fun build(connection: PlayConnection, entityType: EntityType): SmallFireball {
            return SmallFireball(connection, entityType)
        }
    }
}
