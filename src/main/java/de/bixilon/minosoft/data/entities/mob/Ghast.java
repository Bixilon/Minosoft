...
import de.bixilon.minosoft.data.entities.meta.GhastMetaData;
...
public class Ghast extends Mob implements MobInterface {
    ...
    public Ghast(int entityId, UUID uuid, Location location, short yaw, short pitch, short headYaw, EntityMetaData.MetaDataHashMap sets, int protocolId) {
        super(entityId, uuid, location, yaw, pitch, headYaw);
        this.metaData = new GhastMetaData(sets, protocolId);
    }
