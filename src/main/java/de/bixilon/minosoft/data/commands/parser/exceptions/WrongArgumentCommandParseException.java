...
public class WrongArgumentCommandParseException extends CommandParseException {
    ...
    public WrongArgumentCommandParseException(CommandStringReader command, String currentArgument) {
        super(ERROR_MESSAGE, command, currentArgument);
    }

    public WrongArgumentCommandParseException(CommandStringReader command, String currentArgument, Throwable cause) {
