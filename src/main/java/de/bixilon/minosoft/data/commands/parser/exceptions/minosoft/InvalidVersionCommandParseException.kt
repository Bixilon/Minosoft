 ...
 */
package de.bixilon.minosoft.data.commands.parser.exceptions.minosoft

import de.bixilon.minosoft.data.commands.CommandStringReader
import de.bixilon.minosoft.data.commands.parser.exceptions.CommandParseException

class InvalidVersionCommandParseException : CommandParseException {
    ...
    companion object {
        private const val ERROR_MESSAGE = "Invalid version!"
    }
}
