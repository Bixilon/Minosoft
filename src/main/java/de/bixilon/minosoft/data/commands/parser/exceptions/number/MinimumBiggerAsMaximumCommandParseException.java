...
public class MinimumBiggerAsMaximumCommandParseException extends CommandParseException {
    ...
    public MinimumBiggerAsMaximumCommandParseException(CommandStringReader command, String currentArgument) {
        super(ERROR_MESSAGE, command, currentArgument);
    }

    public MinimumBiggerAsMaximumCommandParseException(CommandStringReader command, String currentArgument, Throwable cause) {
