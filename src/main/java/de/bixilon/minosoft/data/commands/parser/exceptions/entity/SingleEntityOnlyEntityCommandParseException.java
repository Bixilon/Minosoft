...
public class SingleEntityOnlyEntityCommandParseException extends CommandParseException {
    ...
    public SingleEntityOnlyEntityCommandParseException(CommandStringReader command, String currentArgument) {
        super(ERROR_MESSAGE, command, currentArgument);
    }

    public SingleEntityOnlyEntityCommandParseException(CommandStringReader command, String currentArgument, Throwable cause) {
