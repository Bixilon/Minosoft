...
public class RangeBadFormatCommandParseException extends CommandParseException {
    ...
    private static final String ERROR_MESSAGE = "Bad Range format!";

    public RangeBadFormatCommandParseException(ImprovedStringReader command, String currentArgument) {
        super(ERROR_MESSAGE, command, currentArgument);
    }

    public RangeBadFormatCommandParseException(ImprovedStringReader command, String currentArgument, Throwable cause) {
