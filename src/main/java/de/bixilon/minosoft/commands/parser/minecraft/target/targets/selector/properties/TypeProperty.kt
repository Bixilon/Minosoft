...
data class TypeProperty(
    ...
    companion object : EntityTargetPropertyFactory<TypeProperty> {
        ...
        override fun read(reader: CommandReader): TypeProperty {
            val (identifier, negated) = reader.readNegateable { readResourceLocation() ?: throw ExpectedArgumentError(reader) } ?: throw ExpectedArgumentError(reader)
            return TypeProperty(identifier, negated)
        }
    }
}
