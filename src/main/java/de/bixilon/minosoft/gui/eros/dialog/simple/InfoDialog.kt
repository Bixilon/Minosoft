...
class InfoDialog(
    ...
    companion object {
        private val LAYOUT = "minosoft:eros/dialog/simple/info.fxml".toResourceLocation()
        private val DEFAULT_TITLE_TEXT = "minosoft:general.dialog.info".toResourceLocation()
