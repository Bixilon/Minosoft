...
class LoadingDialog(
    ...
    companion object {
        private val TITLE = "minosoft:session.dialog.loading.title".toResourceLocation()
        private val HEADER = "minosoft:session.dialog.loading.header".toResourceLocation()
    }
}
