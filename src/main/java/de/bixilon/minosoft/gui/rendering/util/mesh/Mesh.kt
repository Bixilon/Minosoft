...
abstract class Mesh(
    ...
    private val primitiveType: PrimitiveTypes = context.system.preferredPrimitiveType,
    ...
    override val order = context.system.primitiveMeshOrder
    ...
    fun finish() {
        ...
        val data = this.data
        buffer = context.system.createVertexBuffer(struct, data, primitiveType)
