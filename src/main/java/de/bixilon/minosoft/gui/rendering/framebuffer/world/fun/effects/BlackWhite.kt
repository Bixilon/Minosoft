...
class BlackWhite(override val context: RenderContext) : FunEffect {
    ...
    override val shader = createShader(fragment = minosoft("framebuffer/world/fun/black_white.fsh")) { FramebufferShader(it) }


    companion object : FunEffectFactory<BlackWhite> {
        override val identifier = minosoft("black_white")
