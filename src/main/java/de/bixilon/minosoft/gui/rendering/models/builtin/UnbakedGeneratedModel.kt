...
@Deprecated("TODO")
object UnbakedGeneratedModel : GenericUnbakedModel(null, emptyMap()), Identified {
    override val identifier: ResourceLocation = "minecraft:builtin/generated".toResourceLocation()
