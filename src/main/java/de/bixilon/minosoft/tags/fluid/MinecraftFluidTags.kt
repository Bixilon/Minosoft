...
package de.bixilon.minosoft.tags.fluid
...
object MinecraftFluidTags {

    fun Fluid.isIn(tags: TagManager, name: ResourceLocation?): Boolean {
        return tags.isIn(MinecraftTagTypes.ITEM, name, this)
    }

    fun Fluid.isIn(tags: TagList<RegistryItem>?, name: ResourceLocation?): Boolean {
