...
public class PlayerInfoBulk {
    ...
    final PacketPlayerInfo.PlayerInfoAction action;
     ...
     * @param action
     */
    public PlayerInfoBulk(String name, int ping, PacketPlayerInfo.PlayerInfoAction action) {
        this.action = action;
    ...
    public PlayerInfoBulk(UUID uuid, String name, int ping, GameMode gameMode, TextComponent displayName, HashMap<PlayerProperties, PlayerProperty> properties, PacketPlayerInfo.PlayerInfoAction action) {
        this.uuid = uuid;
        this.name = name;
        this.ping = ping;
    ...
    public PacketPlayerInfo.PlayerInfoAction getAction() {
        return action;
    }
}
