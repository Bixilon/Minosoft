...
import de.bixilon.minosoft.game.datatypes.entities.meta.SmallFireballMetaData;
...
public class SmallFireball extends EntityObject implements ObjectInterface {
    ...
    public SmallFireball(int entityId, UUID uuid, Location location, short yaw, short pitch, int additionalInt, Velocity velocity) {
        super(entityId, location, yaw, pitch, velocity);
        this.thrower = additionalInt;
    }

    public SmallFireball(int entityId, UUID uuid, Location location, short yaw, short pitch, Velocity velocity, EntityMetaData.MetaDataHashMap sets, int protocolId) {
        super(entityId, location, yaw, pitch, velocity);
        this.metaData = new SmallFireballMetaData(sets, protocolId);
        this.thrower = 0; // ToDo
    }
