...
public class LightningBolt extends Mob implements MobInterface {
    ...
    public LightningBolt(int entityId, Location location, short yaw, short pitch, Velocity velocity, EntityMetaData.MetaDataHashMap sets, ProtocolVersion version) {
