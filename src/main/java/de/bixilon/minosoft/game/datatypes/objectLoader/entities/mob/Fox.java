...
import de.bixilon.minosoft.game.datatypes.objectLoader.entities.meta.FoxMetaData;
...
public class Fox extends Mob implements MobInterface {
    ...
    public Fox(int entityId, Location location, short yaw, short pitch, Velocity velocity, HashMap<Integer, EntityMetaData.MetaDataSet> sets, ProtocolVersion version) {
        super(entityId, location, yaw, pitch, velocity);
        this.metaData = new FoxMetaData(sets, version);
    }
    ...
    public void setMetaData(EntityMetaData metaData) {
        this.metaData = (FoxMetaData) metaData;
    }
