...
import de.bixilon.minosoft.game.datatypes.objectLoader.entities.meta.CatMetaData;
...
public class Cat extends Mob implements MobInterface {
    ...
    public Cat(int entityId, Location location, short yaw, short pitch, Velocity velocity, HashMap<Integer, EntityMetaData.MetaDataSet> sets, ProtocolVersion version) {
    ...
    public void setMetaData(EntityMetaData metaData) {
        this.metaData = (CatMetaData) metaData;
    }
