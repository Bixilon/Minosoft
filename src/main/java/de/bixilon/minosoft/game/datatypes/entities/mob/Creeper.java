...
public class Creeper extends Mob implements MobInterface {
    ...
    public Creeper(int id, Location location, short yaw, short pitch, Velocity velocity, HashMap<Integer, EntityMetaData.MetaDataSet> sets, ProtocolVersion version) {
