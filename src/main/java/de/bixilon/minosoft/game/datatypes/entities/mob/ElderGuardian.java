...
public class ElderGuardian extends Mob implements MobInterface {
    ...
    public ElderGuardian(int entityId, UUID uuid, Location location, short yaw, short pitch, Velocity velocity, EntityMetaData.MetaDataHashMap sets, int protocolId) {
