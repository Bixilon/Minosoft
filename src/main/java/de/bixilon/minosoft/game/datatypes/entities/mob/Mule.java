...
public class Mule extends Mob implements MobInterface {
    ...
    public Mule(int entityId, UUID uuid, Location location, short yaw, short pitch, Velocity velocity, EntityMetaData.MetaDataHashMap sets, int protocolId) {
        super(entityId, location, yaw, pitch, velocity);
        this.metaData = new MuleMetaData(sets, protocolId);
    }
