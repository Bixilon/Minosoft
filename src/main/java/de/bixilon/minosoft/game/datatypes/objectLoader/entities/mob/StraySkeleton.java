...
import de.bixilon.minosoft.game.datatypes.objectLoader.entities.meta.StraySkeletonMetaData;
...
public class StraySkeleton extends Mob implements MobInterface {
    ...
    public StraySkeleton(int entityId, Location location, short yaw, short pitch, Velocity velocity, HashMap<Integer, EntityMetaData.MetaDataSet> sets, ProtocolVersion version) {
