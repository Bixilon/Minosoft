...
import de.bixilon.minosoft.game.datatypes.objectLoader.entities.meta.CreeperMetaData;
...
public class Creeper extends Mob implements MobInterface {
    ...
    public Creeper(int entityId, Location location, short yaw, short pitch, Velocity velocity, HashMap<Integer, EntityMetaData.MetaDataSet> sets, ProtocolVersion version) {
