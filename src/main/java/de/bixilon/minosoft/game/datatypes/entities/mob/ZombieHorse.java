...
public class ZombieHorse extends Mob implements MobInterface {
    ...
    public ZombieHorse(int entityId, UUID uuid, Location location, short yaw, short pitch, Velocity velocity, EntityMetaData.MetaDataHashMap sets, int protocolId) {
