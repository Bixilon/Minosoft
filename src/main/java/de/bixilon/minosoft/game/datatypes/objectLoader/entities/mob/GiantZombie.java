...
import de.bixilon.minosoft.game.datatypes.objectLoader.entities.meta.GiantZombieMetaData;
...
public class GiantZombie extends Mob implements MobInterface {
    ...
    public GiantZombie(int entityId, Location location, short yaw, short pitch, Velocity velocity, HashMap<Integer, EntityMetaData.MetaDataSet> sets, ProtocolVersion version) {
