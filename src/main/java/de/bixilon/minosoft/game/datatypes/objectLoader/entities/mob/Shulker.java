...
import de.bixilon.minosoft.game.datatypes.objectLoader.entities.meta.ShulkerMetaData;
...
public class Shulker extends Mob implements MobInterface {
    ...
    public Shulker(int entityId, Location location, short yaw, short pitch, Velocity velocity, HashMap<Integer, EntityMetaData.MetaDataSet> sets, ProtocolVersion version) {
        super(entityId, location, yaw, pitch, velocity);
        this.metaData = new ShulkerMetaData(sets, version);
    }
