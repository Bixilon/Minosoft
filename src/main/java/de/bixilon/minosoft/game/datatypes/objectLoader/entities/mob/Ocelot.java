...
import de.bixilon.minosoft.game.datatypes.objectLoader.entities.meta.OcelotMetaData;
...
public class Ocelot extends Mob implements MobInterface {
    ...
    public Ocelot(int entityId, Location location, short yaw, short pitch, Velocity velocity, HashMap<Integer, EntityMetaData.MetaDataSet> sets, ProtocolVersion version) {
        super(entityId, location, yaw, pitch, velocity);
        this.metaData = new OcelotMetaData(sets, version);
    }
