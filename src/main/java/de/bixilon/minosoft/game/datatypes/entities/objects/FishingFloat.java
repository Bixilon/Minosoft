...
public class FishingFloat extends EntityObject implements ObjectInterface {
    ...
    public FishingFloat(int entityId, UUID uuid, Location location, short yaw, short pitch, int additionalInt, Velocity velocity) {
        super(entityId, location, yaw, pitch, velocity);
        this.owner = additionalInt;
    }

    public FishingFloat(int entityId, UUID uuid, Location location, short yaw, short pitch, Velocity velocity, EntityMetaData.MetaDataHashMap sets, int protocolId) {
        super(entityId, location, yaw, pitch, velocity);
