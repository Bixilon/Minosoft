...
public class PacketVehicleMovementServerboundPacket implements PlayServerboundPacket {
    ...
    public PacketVehicleMovementServerboundPacket(double x, double y, double z, float yaw, float pitch) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.yaw = yaw;
