...
public class PlayerRotationServerboundPacket implements PlayServerboundPacket {
    private final EntityRotation rotation;
    private final boolean onGround;

    public PlayerRotationServerboundPacket(EntityRotation rotation, boolean onGround) {
