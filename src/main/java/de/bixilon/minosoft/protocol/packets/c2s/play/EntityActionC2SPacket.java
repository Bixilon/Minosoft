...
public class EntityActionC2SPacket implements PlayC2SPacket {
    private final int entityId;
    private final EntityActions action;
    private final int parameter; // only for horse (jump boost)

    public EntityActionC2SPacket(int entityId, EntityActions action) {
        this.entityId = entityId;
        this.action = action;
        this.parameter = 0;
    }

    public EntityActionC2SPacket(int entityId, EntityActions action, int parameter) {
        this.entityId = entityId;
        this.action = action;
