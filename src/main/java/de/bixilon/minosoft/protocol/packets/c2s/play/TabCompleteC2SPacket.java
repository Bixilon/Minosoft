...
public class TabCompleteC2SPacket implements PlayC2SPacket {
    private final String text;
    private final Vec3i position;
    private final boolean assumeCommand;

    public TabCompleteC2SPacket(String text) {
        this.text = text;
        this.position = null;
        this.assumeCommand = false;
    }

    public TabCompleteC2SPacket(String text, Vec3i position) {
        this.text = text;
        this.position = position;
        this.assumeCommand = false;
    }

    public TabCompleteC2SPacket(String text, boolean assumeCommand, Vec3i position) {
        this.text = text;
        this.position = position;
