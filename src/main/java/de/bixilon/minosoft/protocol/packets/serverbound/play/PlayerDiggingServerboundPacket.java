...
public class PlayerDiggingServerboundPacket implements PlayServerboundPacket {
    private final DiggingStatus status;
    private final Vec3i position;
    private final DiggingFaces face;

    public PlayerDiggingServerboundPacket(DiggingStatus status, Vec3i position, DiggingFaces face) {
        this.status = status;
