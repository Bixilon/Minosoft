...
class InteractAtEntityServerboundPacket(
    entityId: Int,
    val position: Vec3,
    val hand: Hands,
    override val sneaking: Boolean,
) : BaseInteractEntityServerboundPacket(entityId, EntityInteractionActions.INTERACT_AT) {
    ...
    override fun log() {
        Log.protocol("[OUT] Entity interaction (entityId=$entityId, position=($position), hand=$hand, sneaking=$sneaking)")
    }
}
