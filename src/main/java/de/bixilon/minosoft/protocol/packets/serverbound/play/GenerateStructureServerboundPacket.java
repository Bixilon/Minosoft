...
public class GenerateStructureServerboundPacket implements PlayServerboundPacket {
    private final Vec3i position;
    private final int levels;
    private final boolean keepJigsaw;

    public GenerateStructureServerboundPacket(Vec3i position, int levels, boolean keepJigsaw) {
