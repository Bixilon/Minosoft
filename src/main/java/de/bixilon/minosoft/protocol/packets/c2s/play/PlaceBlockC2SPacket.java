...
public class PlaceBlockC2SPacket implements PlayC2SPacket {
    ...
    public PlaceBlockC2SPacket(Vec3i position, byte direction, ItemStack item, float cursorX, float cursorY, float cursorZ) {
    ...
    // >= 1.9
    public PlaceBlockC2SPacket(Vec3i position, byte direction, Hands hand, float cursorX, float cursorY, float cursorZ) {
        this.position = position;
        this.direction = direction;
        this.cursorX = cursorX;
        this.cursorY = cursorY;
    ...
    // >= 1.14
    public PlaceBlockC2SPacket(Vec3i position, byte direction, Hands hand, float cursorX, float cursorY, float cursorZ, boolean insideBlock) {
        this.position = position;
        this.direction = direction;
        this.hand = hand;
        this.cursorX = cursorX;
