...
public class LoginStartServerboundPacket implements PlayServerboundPacket {
    private final String username;

    public LoginStartServerboundPacket(Player player) {
        this.username = player.getEntity().getName();
    }

    public LoginStartServerboundPacket(String username) {
