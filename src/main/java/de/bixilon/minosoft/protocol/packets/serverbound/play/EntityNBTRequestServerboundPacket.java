...
public class EntityNBTRequestServerboundPacket implements PlayServerboundPacket {
    private final int transactionId;
    private final int entityId;

    public EntityNBTRequestServerboundPacket(int transactionId, int entityId) {
