...
class SteerVehicleC2SP(
    ...
    override fun log(reducedLog: Boolean) {
        Log.log(LogMessageType.NETWORK_PACKETS_OUT, LogLevels.VERBOSE) { "Steer vehicle (sideways=$sideways, forward=$forward, jump=$jump, unmount=$unmount)" }
    }
}
