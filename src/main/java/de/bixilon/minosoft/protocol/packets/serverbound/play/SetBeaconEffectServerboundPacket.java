...
public class SetBeaconEffectServerboundPacket implements PlayServerboundPacket {
    private final int primaryEffectId;
    private final int secondaryEffectId;

    public SetBeaconEffectServerboundPacket(int primaryEffectId, int secondaryEffectId) {
