...
public class ClickWindowSlotServerboundPacket implements PlayServerboundPacket {
    ...
    public ClickWindowSlotServerboundPacket(byte windowId, short slot, InventoryActions action, short actionNumber, ItemStack clickedItem) {
