...
public class EntityActionServerboundPacket implements PlayServerboundPacket {
    private final int entityId;
    private final EntityActions action;
    private final int parameter; // only for horse (jump boost)

    public EntityActionServerboundPacket(int entityId, EntityActions action) {
        this.entityId = entityId;
        this.action = action;
        this.parameter = 0;
    }

    public EntityActionServerboundPacket(int entityId, EntityActions action, int parameter) {
        this.entityId = entityId;
        this.action = action;
