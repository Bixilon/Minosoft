...
public class CreativeInventoryActionServerboundPacket implements PlayServerboundPacket {
    private final short slot;
    private final ItemStack clickedItem;

    public CreativeInventoryActionServerboundPacket(short slot, ItemStack clickedItem) {
        this.slot = slot;
