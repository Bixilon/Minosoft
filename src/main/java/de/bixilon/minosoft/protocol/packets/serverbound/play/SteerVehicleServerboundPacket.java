...
public class SteerVehicleServerboundPacket implements PlayServerboundPacket {
    private final float sideways;
    private final float forward;
    private final boolean jump;
    private final boolean unmount;

    public SteerVehicleServerboundPacket(float sideways, float forward, boolean jump, boolean unmount) {
