...
public class PlayerPositionAndRotationServerboundPacket implements PlayServerboundPacket {
    private final Vec3 position;
    private final EntityRotation rotation;
    private final boolean onGround;

    public PlayerPositionAndRotationServerboundPacket(Vec3 position, EntityRotation rotation, boolean onGround) {
