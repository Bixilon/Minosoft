...
public class WindowConfirmationServerboundPacket implements PlayServerboundPacket {
    private final byte windowId;
    private final short actionNumber;
    private final boolean accepted;

    public WindowConfirmationServerboundPacket(byte windowId, short actionNumber, boolean accepted) {
