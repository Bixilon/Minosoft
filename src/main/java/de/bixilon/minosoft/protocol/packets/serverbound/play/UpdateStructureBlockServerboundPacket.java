...
public class UpdateStructureBlockServerboundPacket implements PlayServerboundPacket {
    ...
    public UpdateStructureBlockServerboundPacket(Vec3i position, StructureBlockActions action, StructureBlockModes mode, String name, byte offsetX, byte offsetY, byte offsetZ, byte sizeX, byte sizeY, byte sizeZ, StructureBlockMirrors mirror, StructureBlockRotations rotation, String metaData, float integrity, long seed, byte flags) {
