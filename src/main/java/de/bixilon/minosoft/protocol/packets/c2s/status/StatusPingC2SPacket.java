...
public class StatusPingC2SPacket implements AllC2SPacket {
    private final long id;

    public StatusPingC2SPacket(long id) {
        this.id = id;
    }

    public StatusPingC2SPacket(int id) {
        this.id = id;
    }

    public StatusPingC2SPacket(ConnectionPing ping) {
