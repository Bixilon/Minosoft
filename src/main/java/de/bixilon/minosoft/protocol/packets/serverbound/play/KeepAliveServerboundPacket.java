...
public class KeepAliveServerboundPacket implements PlayServerboundPacket {
    private final long id;

    public KeepAliveServerboundPacket(long id) {
        this.id = id;
    }

    public KeepAliveServerboundPacket(int id) {
        this.id = id;
    }
