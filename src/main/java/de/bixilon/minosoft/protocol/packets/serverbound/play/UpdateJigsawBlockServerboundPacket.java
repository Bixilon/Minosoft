...
public class UpdateJigsawBlockServerboundPacket implements PlayServerboundPacket {
    ...
    public UpdateJigsawBlockServerboundPacket(Vec3i position, String attachmentType, String targetPool, String finalState) {
    ...
    public UpdateJigsawBlockServerboundPacket(Vec3i position, String name, String target, String targetPool, String finalState, String jointType) {
        this.position = position;
        this.name = name;
        this.target = target;
        this.targetPool = targetPool;
