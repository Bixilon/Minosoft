...
public class TabCompleteServerboundPacket implements PlayServerboundPacket {
    private final String text;
    private final Vec3i position;
    private final boolean assumeCommand;

    public TabCompleteServerboundPacket(String text) {
        this.text = text;
        this.position = null;
        this.assumeCommand = false;
    }

    public TabCompleteServerboundPacket(String text, Vec3i position) {
        this.text = text;
        this.position = position;
        this.assumeCommand = false;
    }

    public TabCompleteServerboundPacket(String text, boolean assumeCommand, Vec3i position) {
        this.text = text;
        this.position = position;
