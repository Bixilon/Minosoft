...
public class Protocol_1_12_2 extends Protocol {
    ...
    public Protocol_1_12_2() {
        ...
        registerPacket(Packets.Clientbound.PLAY_ENTITY_MOVEMENT, 0x26);
        registerPacket(Packets.Clientbound.PLAY_ENTITY_MOVEMENT_AND_ROTATION, 0x27);
        registerPacket(Packets.Clientbound.PLAY_ENTITY_ROTATION, 0x28);
        ...
        registerPacket(Packets.Clientbound.PLAY_CRAFT_RECIPE_RESPONSE, 0x2B);
        registerPacket(Packets.Clientbound.PLAY_PLAYER_ABILITIES, 0x2C);
        registerPacket(Packets.Clientbound.PLAY_COMBAT_EVENT, 0x2D);
        registerPacket(Packets.Clientbound.PLAY_PLAYER_INFO, 0x2E);
        registerPacket(Packets.Clientbound.PLAY_PLAYER_POSITION_AND_ROTATION, 0x2F);
        registerPacket(Packets.Clientbound.PLAY_USE_BED, 0x30);
        registerPacket(Packets.Clientbound.PLAY_UNLOCK_RECIPES, 0x31);
        registerPacket(Packets.Clientbound.PLAY_DESTROY_ENTITIES, 0x32);
        registerPacket(Packets.Clientbound.PLAY_REMOVE_ENTITY_EFFECT, 0x33);
        registerPacket(Packets.Clientbound.PLAY_RESOURCE_PACK_SEND, 0x34);
        registerPacket(Packets.Clientbound.PLAY_RESPAWN, 0x35);
        registerPacket(Packets.Clientbound.PLAY_ENTITY_HEAD_ROTATION, 0x36);
        registerPacket(Packets.Clientbound.PLAY_SELECT_ADVANCEMENT_TAB, 0x37);
        registerPacket(Packets.Clientbound.PLAY_WORLD_BORDER, 0x38);
        registerPacket(Packets.Clientbound.PLAY_CAMERA, 0x39);
        registerPacket(Packets.Clientbound.PLAY_HELD_ITEM_CHANGE, 0x3A);
        registerPacket(Packets.Clientbound.PLAY_DISPLAY_SCOREBOARD, 0x3B);
        registerPacket(Packets.Clientbound.PLAY_ENTITY_METADATA, 0x3C);
        registerPacket(Packets.Clientbound.PLAY_ATTACH_ENTITY, 0x3D);
        registerPacket(Packets.Clientbound.PLAY_ENTITY_VELOCITY, 0x3E);
        registerPacket(Packets.Clientbound.PLAY_ENTITY_EQUIPMENT, 0x3F);
        registerPacket(Packets.Clientbound.PLAY_SET_EXPERIENCE, 0x40);
        registerPacket(Packets.Clientbound.PLAY_UPDATE_HEALTH, 0x41);
        registerPacket(Packets.Clientbound.PLAY_SCOREBOARD_OBJECTIVE, 0x42);
        registerPacket(Packets.Clientbound.PLAY_SET_PASSENGERS, 0x43);
        registerPacket(Packets.Clientbound.PLAY_TEAMS, 0x44);
        registerPacket(Packets.Clientbound.PLAY_UPDATE_SCORE, 0x45);
        registerPacket(Packets.Clientbound.PLAY_SPAWN_POSITION, 0x46);
        registerPacket(Packets.Clientbound.PLAY_TIME_UPDATE, 0x47);
        registerPacket(Packets.Clientbound.PLAY_TITLE, 0x48);
        registerPacket(Packets.Clientbound.PLAY_SOUND_EFFECT, 0x49);
        registerPacket(Packets.Clientbound.PLAY_LIST_HEADER_AND_FOOTER, 0x4A);
        registerPacket(Packets.Clientbound.PLAY_COLLECT_ITEM, 0x4B);
        registerPacket(Packets.Clientbound.PLAY_ENTITY_TELEPORT, 0x4C);
        registerPacket(Packets.Clientbound.PLAY_ADVANCEMENTS, 0x4D);
        registerPacket(Packets.Clientbound.PLAY_ENTITY_PROPERTIES, 0x4E);
        registerPacket(Packets.Clientbound.PLAY_ENTITY_EFFECT, 0x4F);
        ...
        registerPacket(Packets.Serverbound.PLAY_PLAYER_POSITION, 0x0D);
        registerPacket(Packets.Serverbound.PLAY_PLAYER_POSITION_AND_ROTATION, 0x0E);
        registerPacket(Packets.Serverbound.PLAY_PLAYER_ROTATION, 0x0F);
        registerPacket(Packets.Serverbound.PLAY_VEHICLE_MOVE, 0x10);
        registerPacket(Packets.Serverbound.PLAY_STEER_BOAT, 0x11);
        registerPacket(Packets.Serverbound.PLAY_CRAFT_RECIPE_REQUEST, 0x12);
        registerPacket(Packets.Serverbound.PLAY_PLAYER_ABILITIES, 0x13);
        registerPacket(Packets.Serverbound.PLAY_PLAYER_DIGGING, 0x14);
        registerPacket(Packets.Serverbound.PLAY_ENTITY_ACTION, 0x15);
        registerPacket(Packets.Serverbound.PLAY_STEER_VEHICLE, 0x16);
        registerPacket(Packets.Serverbound.PLAY_RECIPE_BOOK_DATA, 0x17);
        registerPacket(Packets.Serverbound.PLAY_RESOURCE_PACK_STATUS, 0x18);
        registerPacket(Packets.Serverbound.PLAY_ADVANCEMENT_TAB, 0x19);
        registerPacket(Packets.Serverbound.PLAY_HELD_ITEM_CHANGE, 0x1A);
        registerPacket(Packets.Serverbound.PLAY_CREATIVE_INVENTORY_ACTION, 0x1B);
        registerPacket(Packets.Serverbound.PLAY_UPDATE_SIGN, 0x1C);
        registerPacket(Packets.Serverbound.PLAY_ANIMATION, 0x1D);
        registerPacket(Packets.Serverbound.PLAY_SPECTATE, 0x1E);
        registerPacket(Packets.Serverbound.PLAY_PLAYER_BLOCK_PLACEMENT, 0x1F);
        registerPacket(Packets.Serverbound.PLAY_USE_ITEM, 0x20);
    }
