...
public class Protocol_1_8 extends Protocol {
    ...
    Protocol_1_8() {
        ...
        serverboundPacketMapping.put(Packets.Serverbound.PLAY_SPECTATE, 0x18);
        serverboundPacketMapping.put(Packets.Serverbound.PLAY_RESOURCE_PACK_STATUS, 0x19);
        ...
        clientboundPacketMapping.put(Packets.Clientbound.PLAY_RESOURCE_PACK_SEND, 0x48);
