...
class FireworkRocketRecipe(
    ...
    companion object : SpecialRecipeFactory<FireworkRocketRecipe> {
        override val RESOURCE_LOCATION = minecraft("crafting_special_firework_rocket")

        override fun build(category: RecipeCategories?): FireworkRocketRecipe {
            return FireworkRocketRecipe(category)
        }
    }
}
