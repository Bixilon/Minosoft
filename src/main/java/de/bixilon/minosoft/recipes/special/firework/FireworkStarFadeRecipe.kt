...
class FireworkStarFadeRecipe(
    ...
    companion object : SpecialRecipeFactory<FireworkStarFadeRecipe> {
        override val RESOURCE_LOCATION = minecraft("crafting_special_firework_star_fade")

        override fun build(category: RecipeCategories?): FireworkStarFadeRecipe {
            return FireworkStarFadeRecipe(category)
        }
    }
}
