...
class ArmorDyeRecipe(
    ...
    companion object : SpecialRecipeFactory<ArmorDyeRecipe> {
        override val RESOURCE_LOCATION = minecraft("crafting_special_armordye")

        override fun build(category: RecipeCategories?): ArmorDyeRecipe {
            return ArmorDyeRecipe(category)
        }
    }
}
