...
class BlastingRecipe(
    ...
    companion object : RecipeFactory<BlastingRecipe> {
        override val RESOURCE_LOCATION = "blasting".toResourceLocation()

        override fun build(buffer: PlayInByteBuffer): BlastingRecipe {
