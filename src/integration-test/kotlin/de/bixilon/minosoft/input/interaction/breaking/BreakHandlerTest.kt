...
class BreakHandlerTest {
    ...
    fun haste1() {
        breakBlock(RockBlock.Stone.identifier, WoodenTool.WoodenPickaxe, haste = 1, ticks = 18)!!.assert(productivity = BlockBreakProductivity.EFFECTIVE)
    }

    fun haste1BadTool() {
        breakBlock(RockBlock.Stone.identifier, haste = 1, ticks = 109)!!.assert(productivity = BlockBreakProductivity.INEFFECTIVE)
    }

    fun haste2() {
        breakBlock(RockBlock.Stone.identifier, WoodenTool.WoodenPickaxe, haste = 2, ticks = 16)!!.assert(productivity = BlockBreakProductivity.EFFECTIVE)
    }

    fun haste3() {
        breakBlock(RockBlock.Stone.identifier, WoodenTool.WoodenPickaxe, haste = 3, ticks = 14)!!.assert(productivity = BlockBreakProductivity.EFFECTIVE)
    }

    fun efficiency1() {
        breakBlock(RockBlock.Stone.identifier, WoodenTool.WoodenPickaxe, efficiency = 1, ticks = 13)!!.assert(productivity = BlockBreakProductivity.EFFECTIVE)
    }

    fun efficiency2() {
        breakBlock(RockBlock.Stone.identifier, GoldenTool.GoldenPickaxe, efficiency = 2, ticks = 4)!!.assert(productivity = BlockBreakProductivity.EFFECTIVE)
    }
    ...
    fun air() {
        breakBlock(RockBlock.Stone.identifier, onGround = false, ticks = 751)!!.assert(productivity = BlockBreakProductivity.INEFFECTIVE)
    }

    fun air2() {
        breakBlock(RockBlock.Stone.identifier, DiamondTool.DiamondPickaxe, onGround = false, ticks = 30)!!.assert(productivity = BlockBreakProductivity.EFFECTIVE)
    }
    ...
    fun miningFatigue1() {
        breakBlock(RockBlock.Stone.identifier, GoldenTool.GoldenPickaxe, miningFatigue = 1, ticks = 43)!!.assert(productivity = BlockBreakProductivity.EFFECTIVE)
    }

    fun miningFatigue2() {
        breakBlock(RockBlock.Stone.identifier, GoldenTool.GoldenPickaxe, miningFatigue = 2, ticks = 1390)!!.assert(productivity = BlockBreakProductivity.EFFECTIVE)
    }

    fun miningFatigue3() {
        breakBlock(RockBlock.Stone.identifier, GoldenTool.GoldenPickaxe, miningFatigue = 3, ticks = 4631)!!.assert(productivity = BlockBreakProductivity.EFFECTIVE)
    }

    fun miningFatigue4() {
        breakBlock(RockBlock.Stone.identifier, GoldenTool.GoldenPickaxe, miningFatigue = 4, ticks = 4631)!!.assert(productivity = BlockBreakProductivity.EFFECTIVE)
    }
    ...
    fun stonk() { // hypixel skyblock
        assertNull(breakBlock(RockBlock.Stone.identifier, GoldenTool.GoldenPickaxe, efficiency = 6, haste = 2, ticks = 0))
    }
