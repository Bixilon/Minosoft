...
class GrassTintCalculatorTest {
    private val map by lazy {
        ...
        assets.push(GrassTintCalculator.FILE, GrassTintCalculatorTest::class.java.getResourceAsStream("/tint/grass.png")!!.readAll())
        map.init(assets)
    ...
    fun `color of dessert`() {
        assertEquals(map.getColor(255, 0), 0xBFB755.rgb())
    }
}
