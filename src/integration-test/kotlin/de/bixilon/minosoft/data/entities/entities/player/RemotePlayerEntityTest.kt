...
class RemotePlayerEntityTest {
    ...
    private fun create(): RemotePlayerEntity {
        ...
        return RemotePlayerEntity(session, IT.REGISTRIES.entityType[PlayerEntity]!!, EntityData(session), Vec3d.EMPTY, EntityRotation.EMPTY, PlayerAdditional("Dummy")).apply { init() }
    }
