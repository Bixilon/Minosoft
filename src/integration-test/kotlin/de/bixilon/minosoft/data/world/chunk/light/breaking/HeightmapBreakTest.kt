...
class HeightmapBreakTest {
    ...
    fun testCobweb() {
        ...
        chunk[InChunkPosition(0, 2, 0)] = CobwebTest0.state
    ...
    fun testGlass() {
        ...
        chunk[InChunkPosition(0, 2, 0)] = GlassTest0.state
        chunk[InChunkPosition(0, 2, 0)] = null
        assertTrue(chunk.light.heightmap[0, 0] < 0)
    }
    ...
    fun testLeaves() {
        ...
        chunk[InChunkPosition(0, 2, 0)] = LeavesTest0.state
        chunk[InChunkPosition(0, 2, 0)] = null
        assertEquals(chunk.light.heightmap[0, 0], 2)
    }
    ...
    fun testSlime() {
        ...
        chunk[InChunkPosition(0, 2, 0)] = SlimeTest0.state
        chunk[InChunkPosition(0, 2, 0)] = null
        assertEquals(chunk.light.heightmap[0, 0], 2)
    }
    ...
    fun testStairs() {
        ...
        chunk[InChunkPosition(0, 2, 0)] = IT.REGISTRIES.block[Oak.Stairs]!!.states.default
        chunk[InChunkPosition(0, 2, 0)] = null
    ...
    fun testWater() {
        ...
        chunk[InChunkPosition(0, 2, 0)] = WaterTest0.state
        chunk[InChunkPosition(0, 2, 0)] = null
        assertEquals(chunk.light.heightmap[0, 0], 2)
    }
}
