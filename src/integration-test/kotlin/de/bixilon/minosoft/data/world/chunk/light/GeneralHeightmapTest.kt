...
class GeneralHeightmapTest {
    ...
    fun testMinHeightEast() {
        ...
        chunk[InChunkPosition(2, 10, 3)] = StoneTest0.state
        chunk[InChunkPosition(3, 11, 2)] = StoneTest0.state
        chunk[InChunkPosition(3, 12, 4)] = StoneTest0.state
        chunk[InChunkPosition(4, 13, 3)] = StoneTest0.state
    ...
    fun testMinHeightNeighbourEast() {
        ...
        chunk[InChunkPosition(14, 11, 3)] = StoneTest0.state
        chunk[InChunkPosition(15, 12, 2)] = StoneTest0.state
        chunk[InChunkPosition(15, 13, 4)] = StoneTest0.state
        neighbours[Directions.EAST]?.set(InChunkPosition(0, 10, 3), StoneTest0.state)
    ...
    fun `top of the world and not passing`() {
        val chunk: Chunk = createChunkWithNeighbours()
        chunk[InChunkPosition(2, 255, 3)] = StoneTest0.state
