...
@Test(groups = ["light"], threadPoolSize = 8, priority = 1000)
class BlockLightBreakIT {

    fun inBlock() {
        val world = SessionTestUtil.createSession(3, light = true).world
        world[BlockPosition(8, 10, 8)] = TestBlockStates.TORCH14
    ...
    fun nextNeighbour1() {
        val world = SessionTestUtil.createSession(3, light = true).world
        world[BlockPosition(16, 16, 16)] = TestBlockStates.TORCH14
    ...
    fun nextNeighbour4() {
        val world = SessionTestUtil.createSession(3, light = true).world
        world[BlockPosition(17, 17, 17)] = TestBlockStates.TORCH14
    ...
    fun lowerSection() {
        val world = SessionTestUtil.createSession(3, light = true).world
        world[BlockPosition(8, 16, 8)] = TestBlockStates.TORCH14
    ...
    fun upperSection() {
        val world = SessionTestUtil.createSession(3, light = true).world
        world[BlockPosition(8, 15, 8)] = TestBlockStates.TORCH14
    ...
    fun totalPropagation1() {
        val world = SessionTestUtil.createSession(3, light = true).world
        world[BlockPosition(12, 20, 12)] = TestBlockStates.TORCH14
    ...
    fun lightUpdate() {
        val world = SessionTestUtil.createSession(3, light = true).world
        world[BlockPosition(8, 24, 8)] = TestBlockStates.TORCH14
    ...
    fun bottomLight() {
        val world = SessionTestUtil.createSession(3, light = true).world
        world[BlockPosition(8, 0, 8)] = TestBlockStates.TORCH14
    ...
    fun topLight() {
        val world = SessionTestUtil.createSession(3, light = true).world
        world[BlockPosition(8, 255, 8)] = TestBlockStates.TORCH14
    ...
    fun `increase on break down 1`() {
        val world = SessionTestUtil.createSession(3, light = true).world
        world.fill(BlockPosition(-20, 254, -20), BlockPosition(40, 255, 40), IT.BLOCK_1)
        world[BlockPosition(8, 7, 8)] = TestBlockStates.OPAQUE1
        world[BlockPosition(8, 8, 8)] = TestBlockStates.TORCH14
    ...
    fun `increase on break up`() {
        ...
        world.fill(BlockPosition(-20, 254, -20), BlockPosition(40, 255, 40), IT.BLOCK_1)
        world[BlockPosition(8, 8, 8)] = TestBlockStates.TORCH14
        world[BlockPosition(8, 9, 8)] = TestBlockStates.OPAQUE1
    ...
    fun `increase on break west`() {
        ...
        world.fill(BlockPosition(-20, 254, -20), BlockPosition(40, 255, 40), IT.BLOCK_1)
        world[BlockPosition(8, 8, 8)] = TestBlockStates.TORCH14
        world[BlockPosition(7, 8, 8)] = TestBlockStates.OPAQUE1
    ...
    fun `increase on break east`() {
        ...
        world.fill(BlockPosition(-20, 254, -20), BlockPosition(40, 255, 40), IT.BLOCK_1)
        world[BlockPosition(8, 8, 8)] = TestBlockStates.TORCH14
        world[BlockPosition(9, 8, 8)] = TestBlockStates.OPAQUE1
    ...
    fun `increase on break north`() {
        ...
        world.fill(BlockPosition(-20, 254, -20), BlockPosition(40, 255, 40), IT.BLOCK_1)
        world[BlockPosition(8, 8, 8)] = TestBlockStates.TORCH14
        world[BlockPosition(8, 8, 7)] = TestBlockStates.OPAQUE1
    ...
    fun `increase on break south`() {
        ...
        world.fill(BlockPosition(-20, 254, -20), BlockPosition(40, 255, 40), IT.BLOCK_1)
        world[BlockPosition(8, 8, 8)] = TestBlockStates.TORCH14
        world[BlockPosition(8, 8, 9)] = TestBlockStates.OPAQUE1
