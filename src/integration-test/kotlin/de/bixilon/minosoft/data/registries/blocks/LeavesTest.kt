...
class LeavesTest : BlockTest<LeavesBlock>() {
    ...
    fun `block state flags`() {
        val expected = IntInlineSet() + BlockStateFlags.OUTLINE + BlockStateFlags.FULL_OUTLINE + BlockStateFlags.COLLISIONS + BlockStateFlags.FULL_COLLISION + BlockStateFlags.TINTED + BlockStateFlags.CUSTOM_CULLING
